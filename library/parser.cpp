...
void
Parser::addCookie(RequestImpl *req, const Range &range) {
...
void
Parser::addHeader(RequestImpl *req, const Range &key, const Range &value) {
...
void
Parser::parseCookies(RequestImpl *req, const Range &range) {
